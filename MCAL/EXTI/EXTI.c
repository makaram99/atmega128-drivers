...
void EXTI_EnableExternalInterrupt(const EXTI_t extiNumber) {
    ...
    if(NUM_OF_EXTI_CHANNELS > extiNumber) {
        ...
        SET_BIT(EIFR, extiNumber);      /*!< BIT = INTF0, INTF1, ..., INTF7 */

        /*!< Enable interrupt */
        SET_BIT(EIMSK, extiNumber);     /*!< BIT = INT0, INT1, ..., INT7 */
    } else {
        /* DEBUG    */
    }
...
void EXTI_DisableExternalInterrupt(const EXTI_t extiNumber) {
    ...
    if(NUM_OF_EXTI_CHANNELS > extiNumber) {
        CLR_BIT(EIMSK, extiNumber);     /*!< BIT = INT0, INT1, ..., INT7 */
    } else {
        /* DEBUG    */
    }
...
static void ISR_Generic(const EXTI_t extiNumber) {
    ...
    SET_BIT(EIFR, extiNumber);      /*!< Clear interrupt flag */
