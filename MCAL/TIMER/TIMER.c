...
void TIMER0_EnableOverflowInterrupt(void (* const callback)(void)) {
    ...
    SET_BIT(TIMER_u8_tTIMSK_REG, TOIE0);

    GIE_Enable();
}

void TIMER0_DisableOverflowInterrupt(void) {
    CLR_BIT(TIMER_u8_tTIMSK_REG, TOIE0);
}
...
void TIMER0_EnableCompareMatchInterrupt(void (* const callback)(void)) {
    ...
    SET_BIT(TIMER_u8_tTIMSK_REG, OCIE0);

    GIE_Enable();
}

void TIMER0_DisableCompareMatchInterrupt(void) {
    CLR_BIT(TIMER_u8_tTIMSK_REG, OCIE0);
}
...
void TIMER1_EnableOverflowInterrupt(void (* const callback)(void)) {
    ...
    /* Enable the overflow interrupt */
    SET_BIT(TIMER_u8_tTIMSK_REG, TOIE1);

    GIE_Enable();
}

void TIMER1_DisableOverflowInterrupt(void) {
    CLR_BIT(TIMER_u8_tTIMSK_REG, TOIE1);  /*!< Disable the overflow interrupt */
}
...
void TIMER1_EnableCompareMatchInterrupt(const TIMER_OCx_t OCx, void (* const callback)(void)) {
    ...
    switch(OCx) {
        case TIMER_OCA:
            ...
            SET_BIT(TIMER_u8_tTIMSK_REG, OCIE1A);
            break;
        case TIMER_OCB:
            TIMER_SetCallBack(&TIMER1_COMPB_CBK_PTR, callback);
            SET_BIT(TIMER_u8_tTIMSK_REG, OCIE1B);
            break;
        case TIMER_OCC:
            TIMER_SetCallBack(&TIMER1_COMPC_CBK_PTR, callback);
            SET_BIT(TIMER_u8_tETIMSK_REG, OCIE1C);
            break;
        default:
            break;
    }    
...
void TIMER1_DisableCompareMatchInterrupt(const TIMER_OCx_t OCx) {
    switch(OCx) {
        case TIMER_OCA:
            CLR_BIT(TIMER_u8_tTIMSK_REG, OCIE1A);
            break;
        case TIMER_OCB:
            CLR_BIT(TIMER_u8_tTIMSK_REG, OCIE1B);
            break;
        case TIMER_OCC:
            CLR_BIT(TIMER_u8_tETIMSK_REG, OCIE1C);
            break;
        default:
            break;
    }
...
void TIMER1_EnableCaptureInterrupt(void (* const callback)(void)) {
    ...
    SET_BIT(TIMER_u8_tTIMSK_REG, TICIE1);
...
void TIMER1_DisableCaptureInterrupt(void) {
    ...
    CLR_BIT(TIMER_u8_tTIMSK_REG, TICIE1);
...
static void TIMER0_ConfigMode(const TIMER_MODE_t timerMode) {
    switch(timerMode) {
        case TIMER_MODE_NORMAL:       
            CLR_BIT(TCCR0, WGM00);
            CLR_BIT(TCCR0, WGM01);
            SET_BIT(TCCR0, FOC0);   /*!< Set force output compare mode with non-PWM mode */
            break;
        case TIMER_MODE_CTC:         
            CLR_BIT(TCCR0, WGM00);
            SET_BIT(TCCR0, WGM01);
...
static void TIMER1_ConfigOC(const TIMER_OCx_t OCx, const TIMER_OC_t compareMode) {
    ...
    switch(compareMode) {
        case NO_OC:
            CLR_BIT(TCCR1A, u8_tCom1x0);
            CLR_BIT(TCCR1A, u8_tCom1x1);
            break;
        case TOGGLE_OC:
            SET_BIT(TCCR1A, u8_tCom1x0);
            CLR_BIT(TCCR1A, u8_tCom1x1);
            /* 
...
void __vector_16(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, TOV0);    /*!< Clear the interrupt flag */
...
void __vector_15(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, OCF0);    /*!< Clear the interrupt flag */
...
void __vector_14(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, TOV1);    /*!< Clear the interrupt flag */
...
void __vector_13(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, OCF1B);   /*!< Clear the interrupt flag */
...
void __vector_12(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, OCF1A);   /*!< Clear the interrupt flag */
...
void __vector_24(void) {
    ...
    SET_BIT(TIMER_u8_tETIFR_REG, OCF1C);  /*!< Clear the interrupt flag */
...
void __vector_11(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, ICF1);    /*!< Clear the interrupt flag */
...
void __vector_10(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, TOV2);    /*!< Clear the interrupt flag */
...
void __vector_9(void) {
    ...
    SET_BIT(TIMER_u8_tTIFR_REG, OCF2);    /*!< Clear the interrupt flag */
...
void __vector_29(void) {
    ...
    SET_BIT(TIMER_u8_tETIFR_REG, TOV3);   /*!< Clear the interrupt flag */
...
void __vector_28(void) {
    ...
    SET_BIT(TIMER_u8_tETIFR_REG, OCF3C);  /*!< Clear the interrupt flag */
...
void __vector_27(void) {
    ...
    SET_BIT(TIMER_u8_tETIFR_REG, OCF3B);  /*!< Clear the interrupt flag */
...
void __vector_26(void) {
    ...
    SET_BIT(TIMER_u8_tETIFR_REG, OCF3A);  /*!< Clear the interrupt flag */
...
void __vector_25(void) {
    ...
    SET_BIT(TIMER_u8_tETIFR_REG, ICF3);   /*!< Clear the interrupt flag */
