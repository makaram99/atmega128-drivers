 ...
 * @par   For Example: UART0_SendString("Hello World"); will send string 
 *        "Hello World" to UART module 0
 *****************************************************************************/
 ...
 * @return The error code: ERROR_OK if no error, ERROR_NOK if error
