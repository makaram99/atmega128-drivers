...
DIO_PIN_CONFIGS_t  pinConfigs[] = {
    /* Keypad   */
    {DIO_PIN_4, DIO_PORT_B, DIO_OUTPUT, DIO_PULLUP_OFF},
    {DIO_PIN_5, DIO_PORT_B, DIO_OUTPUT, DIO_PULLUP_OFF},
    {DIO_PIN_6, DIO_PORT_B, DIO_OUTPUT, DIO_PULLUP_OFF},
    {DIO_PIN_7, DIO_PORT_B, DIO_OUTPUT, DIO_PULLUP_OFF},
    {DIO_PIN_2, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_ON},
    {DIO_PIN_3, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_ON},
    {DIO_PIN_4, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_ON},
    {DIO_PIN_5, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_ON},

    /* Buzzer pin   */
    {DIO_PIN_3, DIO_PORT_C, DIO_OUTPUT, DIO_PULLUP_OFF},
