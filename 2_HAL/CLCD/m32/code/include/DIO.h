...
#define DIO_InitPin(pin, port, direction, pullup)                               \
        (                                                                       \
          DIO_SetPinDirection(&(DIR_CONFIGS_t){pin, port, direction}) | \
          DIO_SetClrPinPullup(&(PUD_CONFIGS_t){pin, port, pullup})   \
        )
...
#define DIO_SetPinPullup(pin, port)     \
        DIO_SetClrPinPullup(&(PUD_CONFIGS_t){pin, port, DIO_PULLUP_ON})
...
#define DIO_ClrPinPullup(pin, port) \
        DIO_SetClrPinPullup(&(PUD_CONFIGS_t){pin, port, DIO_PULLUP_OFF})
