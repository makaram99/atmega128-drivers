...
DIO_PIN_CONFIGS_t  pinConfigs[] = {
    ...
    /* LED  */
    {DIO_PINS_LED_0, DIO_PIN_0, DIO_PORT_C, DIO_OUTPUT, DIO_PULLUP_OFF},
    {DIO_PINS_LED_1, DIO_PIN_1, DIO_PORT_C, DIO_OUTPUT, DIO_PULLUP_OFF},
    {DIO_PINS_LED_2, DIO_PIN_2, DIO_PORT_C, DIO_OUTPUT, DIO_PULLUP_OFF},

    /* Testing LED  */
    {DIO_PINS_TEST_LED, DIO_PIN_7, DIO_PORT_C, DIO_OUTPUT, DIO_PULLUP_OFF},
};
