...
ERROR_t LM35_Read(const LM35_t lm35, u16_t * const ptrToValue);
ERROR_t LM35_ReadAsync(const LM35_t lm35, u16_t * const ptrToValue, void (* const LM35_Callback) (void));
