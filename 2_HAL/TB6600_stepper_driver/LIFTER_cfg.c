...
LIFTER_CONFIGS_t LifterConfigs = {
     .directionPin       = DIO_PIN_4,        /* Direction pin of the lifter */
     .directionPinPort   = DIO_PORT_D,       /* Direction pin port of the lifter */
     .pulsePin           = DIO_PIN_5,        /* Pulse pin of the lifter */
     .pulsePinPort       = DIO_PORT_D,       /* Pulse pin port of the lifter */
     .enablePin          = DIO_PIN_6,        /* Enable pin of the lifter */
     .enablePinPort      = DIO_PORT_D,       /* Enable pin port of the lifter */
