...
void WHEELS_GoForward(void) {
    ...
    DIO_SetPinValue(WHEELS_Config.ENA_pin, WHEELS_Config.ENA_port, HIGH);
    DIO_SetPinValue(WHEELS_Config.ENB_pin, WHEELS_Config.ENB_port, HIGH);
}
...
void WHEELS_Coast(void) {
    ...
    DIO_SetPinValue(WHEELS_Config.ENA_pin, WHEELS_Config.ENA_port, LOW);
    DIO_SetPinValue(WHEELS_Config.ENB_pin, WHEELS_Config.ENB_port, LOW);
}
