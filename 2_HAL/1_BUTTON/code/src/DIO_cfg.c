...
DIO_PIN_CONFIGS_t  pinConfigs[] = {
    /* BUTTONs   */
    {DIO_PIN_0, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_OFF},
    {DIO_PIN_1, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_OFF},
    {DIO_PIN_2, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_OFF},
    {DIO_PIN_3, DIO_PORT_D, DIO_INPUT, DIO_PULLUP_OFF},

    /* LEDs   */
    {DIO_PIN_3, DIO_PORT_C, DIO_OUTPUT, DIO_PULLUP_OFF},
    {DIO_PIN_4, DIO_PORT_C, DIO_OUTPUT, DIO_PULLUP_OFF},
